...
export const CarritoProvider = ({children}) =>  {
    ...
    const agregarAlCarrito = (item, cantidad) => {
        ...
        if(!productoExistente){
            ...
            //La sintaxis: prev => [...prev, {item, cantidad}] se utiliza para crear un nuevo array a partir del estado anterior del carrito y agreagr un nuevo objeto que representa el producto agregado
